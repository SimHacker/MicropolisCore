...
Full email thread archived: [WillWrightShowForFood — Jeff Braun, Feb 2024](https://github.com/SimHacker/WillWrightShowForFood/blob/main/characters/jeff-braun/sources/email-godzilla-toho-2024-02-17.md). Box art: [SimCity Macintosh front cover (1989)](https://github.com/SimHacker/WillWrightShowForFood/blob/main/characters/will-wright/media/simcity-macintosh-front-cover.jpg).
