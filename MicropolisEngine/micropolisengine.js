...
// end include: /tmp/tmpkxs07ra2.js
// include: /tmp/tmp_6fl7_9d.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['ENVIRONMENT_IS_PTHREAD'] || Module['$ww']) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp_6fl7_9d.js
// include: /tmp/tmpi1m159yx.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpi1m159yx.js
...
var wasmBinaryFile;
  wasmBinaryFile = 'micropolisengine.wasm';
...
var ASM_CONSTS = {
  82056: () => { console.log('~ConsoleCallback destructor'); },  
 82104: ($0, $1, $2) => { console.log('autoGoto:', 'x:', $0, 'y:', $1, 'message:', UTF8ToString($2)); },  
 82184: ($0) => { console.log('didGenerateMap:', 'seed:', $0); },  
 82233: ($0) => { console.log('didLoadCity:', 'filename:', UTF8ToString($0)); },  
 82297: ($0, $1) => { console.log('didLoadScenario:', 'name:', UTF8ToString($0), 'fname:', UTF8ToString($1)); },  
 82389: () => { console.log('didLoseGame'); },  
 82421: ($0) => { console.log('didSaveCity:', 'filename:', UTF8ToString($0)); },  
 82485: ($0, $1, $2) => { console.log('didTool:', 'name:', UTF8ToString($0), 'x:', $1, 'y:', $2); },  
 82561: () => { console.log('didWinGame'); },  
 82592: ($0) => { console.log('didntLoadCity:', 'filename:', UTF8ToString($0)); },  
 82658: ($0) => { console.log('didntSaveCity:', 'filename:', UTF8ToString($0)); },  
 82724: ($0, $1, $2, $3) => { console.log('makeSound:', 'channel:', UTF8ToString($0), 'sound:', UTF8ToString($1), 'x:', $2, 'y:', $3); },  
 82833: () => { console.log('newGame'); },  
 82861: ($0) => { console.log('saveCityAs:', 'filename:', UTF8ToString($0)); },  
 82924: ($0, $1, $2, $3, $4) => { console.log('sendMessage:', 'messageIndex:', $0, 'x:', $1, 'y:', $2, 'picture:', $3, 'important:', $4); },  
 83032: () => { console.log('showBudgetAndWait'); },  
 83070: ($0, $1, $2, $3, $4, $5, $6, $7) => { console.log('showZoneStatus:', 'tileCategoryIndex:', $0, 'populationDensityIndex:', $1, 'landValueIndex:', $2, 'crimeRateIndex:', $3, 'pollutionIndex:', $4, 'growthRateIndex:', $5, 'x:', $6, 'y:', $7); },  
 83276: () => { console.log('simulateRobots'); },  
 83311: ($0, $1, $2) => { console.log('simulateChurch:', 'posX:', $0, 'posY:', $1, 'churchNumber:', $2); },  
 83394: ($0) => { console.log('startEarthquake:', 'strength:', $0); },  
 83448: () => { console.log('startGame'); },  
 83478: ($0) => { console.log('startScenario:', 'scenario:', $0); },  
 83530: () => { console.log('updateBudget'); },  
 83563: ($0) => { console.log('updateCityName:', 'cityName:', UTF8ToString($0)); },  
 83630: ($0, $1) => { console.log('updateDate:', 'cityYear:', $0, 'cityMonth:', $1); },  
 83697: ($0, $1, $2) => { console.log('updateDemand:', 'r:', $0, 'c:', $1, 'i:', $2); },  
 83761: () => { console.log('updateEvaluation'); },  
 83798: ($0) => { console.log('updateFunds:', 'totalFunds:', $0); },  
 83850: ($0) => { console.log('updateGameLevel:', 'gameLevel:', $0); },  
 83905: () => { console.log('updateHistory'); },  
 83939: () => { console.log('updateMap'); },  
 83969: () => { console.log('updateOptions'); },  
 84003: ($0) => { console.log('updatePasses:', 'passes:', $0); },  
 84052: ($0) => { console.log('updatePaused:', 'simPaused:', $0); },  
 84104: ($0) => { console.log('updateSpeed:', 'speed:', $0); },  
 84151: ($0) => { console.log('updateTaxRate:', 'cityTax:', $0); }
};
