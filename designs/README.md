...
- `wasm-bridge-and-testing-trajectory.md` — Vitest setup, **`wasmHeap`** / **`MicropolisReactive.svelte`**, integration tests against WASM, Embind teardown lessons, backlog, and alignment with command path / MCP goals.
