...
- **[Bret Victor](/pages/about/bret-victor)** - His revolutionary work on explorable explanations and interactive visualization has shaped how we approach making SimCity's systems visible and manipulable.

  > "Creators need an immediate connection to what they're creating." — [Bret Victor](/pages/about/bret-victor#revolutionary-approach-to-interface-design)
