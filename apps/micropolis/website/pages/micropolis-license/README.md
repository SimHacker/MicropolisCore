...
slug: micropolis-license
path: /micropolis-license
header: "Micropolis Licensing"
description: ⚖️ Review the **GPL license** with **EA** modifications and the **Micropolis Public Name License** that govern this project.
nav:
  order: 80
...
- [Micropolis GPL License Notice](#micropolis-gpl-license-notice)
- [Micropolis Public Name License](#micropolis-public-name-license)

## Introduction {#introduction}

The [**Micropolis**](#) project operates under two important licenses:

1. The **Micropolis GPL License Notice** - This is the **GNU General Public License** with additional terms added by [**Electronic Arts**](https://www.ea.com) to protect the **SimCity** trademark while allowing the code to be freely used and modified.
...
For the complete text of the [**GNU General Public License v3**](https://www.gnu.org/licenses/gpl-3.0.html), please refer to the official **GNU** website.
...
1.  Give proper attribution. Copying, forking and or using the source code
    ...
    **courtesy of the owner under the Micropolis Public Name License.**"
    ...
    [https://www.micropolis.com](https://www.micropolis.com) and optionally to the license text.
...
6.  Dispute resolution and jurisdiction. Court of jurisdiction is **Amsterdam**, the
