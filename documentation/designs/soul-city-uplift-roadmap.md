# Soul City Uplift — Phased Roadmap
...
> **Scope.** Content creation and discovery tooling; the Sims engine remains the runtime. See [soul-city.md → Scope and intent](soul-city.md#scope-and-intent) for the canonical positioning.

---

## Purpose

This document is the **build plan** for Soul City. The strategic vision lives in [soul-city.md](soul-city.md); the substrate model in [moollm-microworld-os.md](moollm-microworld-os.md); the archive-recovery pipeline in [the-tornado-and-the-archives.md](the-tornado-and-the-archives.md). This document says **what to actually ship and in what order**.
...
**The minimum demo.** Drop a `.iff` save (from the player's *own* EA-published Sims 1 install) into the Soul City companion app in a browser tab. Watch one character become a MOOLLM `CHARACTER.yml`. Talk to them. Edit them. Write a new `.iff` back out **for the player to load into their own EA Sims install**.
...
The point at which Soul City stops being two apps and becomes one world.

### Track A: Data contract (three binding patterns)

The zone↔save binding has three canonical patterns — see [soul-city.md → How Sims save files actually bind to Micropolis tiles](soul-city.md#how-sims-save-files-actually-bind-to-micropolis-tiles):
...
## Definition of "done" for Soul City as a whole
...
When all five of these are reliably true, Soul City is a thing, not a roadmap.
...
| Resource | Where |
|---|---|
| Strategic vision | [soul-city.md](soul-city.md) |
