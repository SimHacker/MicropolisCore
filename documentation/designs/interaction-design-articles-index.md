...
| 4b | [`GONZO-UI-MANIFEST.md`](GONZO-UI-MANIFEST.md) | Fear & loathing of sterilized chrome; felt creatures; **skinnable** Gonzo kernel + per-bridge skins (Sims first) — HST + Sims Framework shop name | …you're shaping chrome personality, bridge UIs, or multi-game session look without abandoning HCI |
