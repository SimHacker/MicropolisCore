...
| **Sim Archive Project** ([`sim-archive-project`](https://archive.org/details/sim-archive-project)) | Community-led Internet Archive collection for player-made Sims content across Sims 1–3. Exchange scrapes at specific points in time (items, recolors, sims, patterns, lots, families — not a complete archive), plus community CC uploads. Don Hopkins consulted at founding. | Active collection on `archive.org`. Prefer packaged items here over raw Wayback CDX where available. See [`content/simopolis/archives/SOURCES.yml`](../../content/simopolis/archives/SOURCES.yml). |
| **TSO Conversions for TS1** ([`tsoconversions`](https://archive.org/details/tsoconversions)) | Skins, heads, and objects cloned from *The Sims Online* for *The Sims 1*. Packaged ZIPs (`TSO_Conversions.zip`, heads collection). | In Sim Archive Project collection. First concrete TS1 skin/object bundle for tornado Stage 3 parse. |
| **Persimmon Grove** ([`Persimmon`](https://archive.org/details/Persimmon)) | Koromo's classic TS1 house-and-garden objects (indoors/outdoors). Base-game compatible. Cloning permitted with acknowledgment. Live at [persimmon.ephralon.de](https://persimmon.ephralon.de/). | In Sim Archive Project collection. High-priority fan CC for object recovery. |
| **Bunny Wuffles Architectural Supplies** ([`bunnywufflesarchitecturalsupplies`](https://archive.org/details/bunnywufflesarchitecturalsupplies)) | Themed architectural objects, walls, floors, houses; object-creation tutorials. Recolour/retexture permitted with credit. Archives at [sas.woobsha.com](http://sas.woobsha.com/). | In Sim Archive Project collection. ~176 MB RAR. High-priority fan CC. |
| **Sims 1 Official Downloads** ([`sims1officialdownloads`](https://archive.org/details/sims1officialdownloads)) | Official Maxis download bundle mirrored from community archive sites (simechoes, thesimsdepot, simarchive.wordpress.com). | **Reference source**, not lot-binding: dependency baseline, parse validation, expansion-conflict detection. Some items duplicate expansion content. |
| **TS1 Branded Objects** ([`TS1BrandedObjects`](https://archive.org/details/TS1BrandedObjects)) | Official Maxis advertising objects: Pepsi machine, McDonald's kiosk, Intel computer. | **Reference source** for Content Registry object identification. |
| **The Sims Jukebox** ([`thesimsjukebox`](https://archive.org/details/thesimsjukebox)) | Official Maxis desktop jukebox app (2000). Windows executable — play your own tunes Sims-style. | **Reference / template** for a future jukebox creator tool. Not tornado import. |
...
We start with a list. The list lives at `content/simopolis/archives/SOURCES.yml`. Each entry has: the live URL (if any), known `archive.org` collections, expected content types, crawl politeness budget, license assumptions, and a status flag. The list is hand-maintained and PR-able. We do not auto-expand it without review. The first seeded entry is the [Sim Archive Project](https://archive.org/details/sim-archive-project) collection — community-packaged Exchange and CC bundles that complement (and often beat) raw Wayback CDX pulls.
...
| **Sim Archive Project** (IA collection — tornado first source) | [https://archive.org/details/sim-archive-project](https://archive.org/details/sim-archive-project) |
| **TSO Conversions for TS1** (skins, heads, objects) | [https://archive.org/details/tsoconversions](https://archive.org/details/tsoconversions) |
| **Persimmon Grove** (Koromo house & garden CC) | [https://archive.org/details/Persimmon](https://archive.org/details/Persimmon) · [live site](https://persimmon.ephralon.de/) |
| **Bunny Wuffles Architectural Supplies** | [https://archive.org/details/bunnywufflesarchitecturalsupplies](https://archive.org/details/bunnywufflesarchitecturalsupplies) · [archives](http://sas.woobsha.com/) |
| **Sims 1 Official Downloads** (Maxis — registry baseline) | [https://archive.org/details/sims1officialdownloads](https://archive.org/details/sims1officialdownloads) |
| **TS1 Branded Objects** (Pepsi, McDonald's, Intel) | [https://archive.org/details/TS1BrandedObjects](https://archive.org/details/TS1BrandedObjects) |
| **The Sims Jukebox** (jukebox creator template, 2000) | [https://archive.org/details/thesimsjukebox](https://archive.org/details/thesimsjukebox) |
