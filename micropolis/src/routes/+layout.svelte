<script>
	...
	// export let data; // REMOVED

	// Reactive variable to easily access the full path from the page data
	$: currentPath = $page.data?.fullPath || [];
	// Get the URL of the current page node itself (less critical here now)
