...
// content pages, and external links.
...
export const siteStructure = [
    // 1. Root Page (Now dynamically generated index)
    {
        url: '/',
        title: 'Micropolis Web',
        header: 'Site Index', // Update header
        description: 'An index of all pages on the Micropolis Web site.', // Update description
        tooltip: 'Go to Micropolis Web Site Index', // Update tooltip
    },
    // 2. About Section
    {
        url: '/pages/about',
        title: 'About Micropolis', // Update title for tab
    ...
    // 4. Reverse Diagrams
    {
        ...
        title: 'Reverse Diagrams', // Two words for consistency
    ...
    // 5. Micropolis License
    {
        url: '/pages/micropolis-license',
        title: 'Micropolis License', // Two words for consistency
